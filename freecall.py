...
# ==========================================
# কনফিগারেশন - আপনার বট টোকেন ও আইডি
# ==========================================
BOT_TOKEN = "8525457354:AAH8qZfjvmJAuwpdN4tPS9kIoNIwk0JiwYw"
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Single Button Keyboard UI
    keyboard = [['📞 প্র্যাঙ্ক কল']]
    reply_markup = ReplyKeyboardMarkup(keyboard, resize_keyboard=True)

    welcome_text = (
        f"🔰 **স্বাগতম {user.first_name}!**\n\n"
        "প্র্যাঙ্ক কল পাঠাতে নিচের **📞 প্র্যাঙ্ক কল** বাটনে ক্লিক করুন।"
    )
